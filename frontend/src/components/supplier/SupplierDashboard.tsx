        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              <Link to="/supplier/dashboard" className="text-blue-900 font-medium border-b-2 border-blue-900 pb-1">
                Dashboard
              </Link>
              ...
              <Link to="/supplier/inventory" className="text-slate-700 hover:text-blue-900 font-medium">
                Inventory
              </Link>
              ...
              <div className="p-6 space-y-3">
                ...
                <button className="w-full flex items-center justify-between p-3 rounded-lg hover:bg-slate-50 transition-colors group border border-slate-100">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="font-medium text-slate-900">Sync Drop Ship</span>
                  </div>
                  <svg className="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
